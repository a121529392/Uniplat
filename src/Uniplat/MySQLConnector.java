...
try{
    ...
    public static Check_DateTime_Name_User_Model Check_Uniplat_Summary(String user, String date) throws SQLException {
        config c = new config();
        ...
        sql.connectDB();
        String query = "SELECT * FROM Summary where User_ID='" + user + "'and DateTime='" + date + "'";
    ...
    public static Check_User_DateTime_Name_StTime_EdTime_Model Check_Uniplat_Activity_Detail(String user, String id) throws SQLException {
        config c = new config();
        Check_User_DateTime_Name_StTime_EdTime_Model data = new Check_User_DateTime_Name_StTime_EdTime_Model();

        MySQLConnector sql = new MySQLConnector(c.getUrlstr(), c.getUserStr(), c.getPwStr(), c.getDBname());
        sql.connectDB();
        String query = "SELECT * FROM Activity_Detail where User_ID='" + user + "' and ID_ACTIVITY='" + id + "'";
        data.dateTime = sql.getdata(query, "DateTime");
        data.name = sql.getdata(query, "ID_Activity");
        data.user = sql.getdata(query, "User_ID");
        data.starttime = sql.getdata(query, "StartTime");
        data.endtime = sql.getdata(query, "EndTime");
        sql.close();
        return data;
    }
    ...
    public static Check_DateTime_Name_User_Model Check_uniplat_Activity_Heart(String user, String date) throws SQLException {
        config c = new config();
        // sdfsdfsdfsdsfsdfsdfsfsfsdfsdfsdfsdf
        Check_DateTime_Name_User_Model data = new Check_DateTime_Name_User_Model();
        MySQLConnector sql = new MySQLConnector(c.getUrlstr(), c.getUserStr(), c.getPwStr(), c.getDBname());
        sql.connectDB();
        String query = "SELECT * FROM Activity_Heart where User_ID='" + user + "' and DateTime='" + date + "'";
        data.dateTime = sql.getdata(query, "DateTime");
        data.name = sql.getdata(query, "HeartrateName");
        data.user = sql.getdata(query, "User_ID");
        sql.close();
        return data;
    }

    public static Check_User_DateTime_StTime_EdTime_Model Check_uniplat_Heartrate_Detail(String user, String date) throws SQLException {
        config c = new config();

        Check_User_DateTime_StTime_EdTime_Model data = new Check_User_DateTime_StTime_EdTime_Model();
    ...
    public static Check_User_DateTime_StTime_EdTime_Model Check_uniplat_Sleep_Detial(String user, String date) throws SQLException {
        config c = new config();
        Check_User_DateTime_StTime_EdTime_Model data = new Check_User_DateTime_StTime_EdTime_Model();
        MySQLConnector sql = new MySQLConnector(c.getUrlstr(), c.getUserStr(), c.getPwStr(), c.getDBname());
        sql.connectDB();
        String query = "SELECT * FROM Sleep_Detail where User_ID='" + user + "'and DateTime='" + date + "'";
        data.dateTime = sql.getdata(query, "DateTime");
        data.user = sql.getdata(query, "User_ID");
        data.starttime = sql.getdata(query, "StartTime");
        data.endtime = sql.getdata(query, "EndTime");
